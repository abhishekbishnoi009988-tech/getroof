  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        ...
        {user?.role === 'broker' && (
          <div className="mb-8"><BrokerEarnings /></div>
        )}

        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div onClick={() => navigate('/properties?type=buy')}
          ...
          <div onClick={() => navigate('/properties?type=rent')}
            className="bg-white rounded-lg shadow-lg p-8 cursor-pointer hover:shadow-xl transition-shadow">
            <div className="text-5xl mb-4">🔑</div>
          ...
          <div onClick={() => navigate('/upload-house')}
            className="bg-white rounded-lg shadow-lg p-8 cursor-pointer hover:shadow-xl transition-shadow">
        ...
        <div className="mt-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            {user?.role === 'broker' ? (
              <>
                <button onClick={() => navigate('/broker/record-sale')}
                ...
                <button onClick={() => navigate('/broker/payment-history')}
                ...
                <button onClick={() => navigate('/broker/withdrawal')}
                  className="bg-orange-500 text-white px-6 py-4 rounded-lg hover:bg-orange-600 text-left">
                  <div className="font-semibold text-lg">💸 Withdrawal</div>
                  <div className="text-sm opacity-90">Withdraw your earnings to bank/UPI</div>
                </button>
              </>
            ) : (
              <button onClick={() => navigate('/become-broker')}
                className="bg-blue-600 text-white px-6 py-4 rounded-lg hover:bg-blue-700 text-left">
