...
app.use(
  cors({
    origin: ['http://localhost:5173', 'http://localhost:3000', 'https://getroof.in', 'https://www.getroof.in'],
    credentials: true,
...
// Mount routers - BOTH v1 AND non-v1 paths
...
// Support /api/* routes (without v1) for backward compatibility
